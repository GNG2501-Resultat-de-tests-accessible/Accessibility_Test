				...
				<SafeAreaView style={styles.iosSafeArea}>
					...
					<Animated.View style={[styles.mainContainer, fadingupAnimation]}>
						...
						<View style={styles.imageContainer}>
							<ImageViewer imageSource={require("../assets/Access-19.png")} />
						</View>
					...
					<Animated.View
						style={[styles.InstructionView, FirstInstructAnimation]}
					>
						<View style={[styles.InstructionBlock, themeContainerStyle]}>
							<View style={[styles.ImageContainer]}>
								<Image
									source={require("../assets/homepage_image.png")}
									style={styles.ImageInstruction}
								/>
							</View>
							<View style={[styles.InstructionInsideBlock]}>
								<Text style={styles.InstructionTitle}>Start</Text>
								<Text style={[styles.InstructionDescription, themeTextStyle]}>
									Start by clicking on the start button or use text command
								</Text>
							</View>
						</View>
					</Animated.View>
					...
					<Animated.View
						style={[styles.InstructionView, SecondInstructAnimation]}
					>
						<View style={[styles.InstructionBlock, themeContainerStyle]}>
							<View style={[styles.ImageContainer]}>
								<Image
									source={require("../assets/ScanningCovid.png")}
									style={[
										styles.ImageInstruction,
										{ width: screenWidth * 0.5, height: screenHeight * 0.5 },
									]}
								/>
							</View>
							<View style={[styles.InstructionInsideBlock]}>
								...
								<Text style={[styles.InstructionDescription, themeTextStyle]}>
									Take a picture of the covid test by placing it in the middle
									of the camera
								</Text>
							</View>
						</View>
					...
					<Animated.View
						style={[styles.InstructionView, ThirdInstructAnimation]}
					>
						<View style={[styles.InstructionBlock, themeContainerStyle]}>
							<View style={[styles.ImageContainer]}>
								<Image
									source={require("../assets/Bot_Analysing.png")}
									style={styles.ImageInstruction}
								/>
							</View>
							<View style={[styles.InstructionInsideBlock]}>
								...
								<Text style={[styles.InstructionDescription, themeTextStyle]}>
									The system will analyse and indicate the result of the test
								</Text>
							</View>
						</View>
					</Animated.View>
